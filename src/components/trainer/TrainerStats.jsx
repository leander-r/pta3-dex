    ...
    return (
        <div className="section-card-purple">
            <h3 className="section-title-purple">
                <span>📊</span> Stats
                <span style={{ marginLeft: 'auto', fontSize: '12px', fontWeight: 'normal', color: '#666' }} title="Creation points are used during character creation (min 6, max 14). Level points are gained when leveling up.">
            ...
            <div style={{ marginTop: '15px' }}>
                ...
                <div className="grid-responsive-3">
                    <div style={{ textAlign: 'center', padding: '8px', background: '#e3f2fd', borderRadius: '6px' }} title="Physical Evasion = DEF ÷ 5 (rounded down). Applies vs Physical attacks.">
                    ...
                    <div style={{ textAlign: 'center', padding: '8px', background: '#fff3e0', borderRadius: '6px' }} title="Special Evasion = SDEF ÷ 5 (rounded down). Applies vs Special attacks.">
                    ...
                    <div style={{ textAlign: 'center', padding: '8px', background: '#e0f7fa', borderRadius: '6px' }} title="Speed Evasion = SPD modifier (capped 0-6). Applies to dodge-based checks.">
